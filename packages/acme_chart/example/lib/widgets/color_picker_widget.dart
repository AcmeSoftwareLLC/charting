...
class AcmeColorPicker extends StatelessWidget {
  /// Creates an AcmeColorPicker widget.
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        if (label != null) SizedBox(width: labelWidth, child: Text(label!)),
...
Future<Color?> showAcmeColorPickerDialog(
  BuildContext context, {
  required Color initialColor,
  String title = 'Select Color',
}) async {
  final colorPickerKey = GlobalKey<_AcmeColorPickerDialogState>();
...
class AcmeColorPickerDialog extends StatefulWidget {
  ...
  @override
  State<AcmeColorPickerDialog> createState() => _AcmeColorPickerDialogState();
}

class _AcmeColorPickerDialogState extends State<AcmeColorPickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final contrastInfo = ColorUtils.checkContrast(
      _selectedColor,
      backgroundColor,
    );
