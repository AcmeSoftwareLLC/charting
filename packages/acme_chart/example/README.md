# 📱 Acme Chart Showcase App

A Flutter application showcasing the features and capabilities of the Acme Chart package.

## 🔍 Overview

This showcase app demonstrates various chart types and features available in the Acme Chart package. It serves as both a visual demonstration and a reference implementation for developers using the package.
...
Each example screen demonstrates a specific feature of the Acme Chart package with interactive controls to modify chart parameters and see changes in real-time. The app includes:

- **🎚️ Sliders** — Adjust numerical parameters such as time intervals, indicator sensitivity, or opacity
...
- **📡 Sample Data Generation** — Auto-generated using a simulated market algorithm that produces realistic price movements and patterns

## 🧪 Testing

This app is structured to support multiple testing strategies:

1. **🤖 Automation Testing** — Semantic labels and consistent widget keys enable automated UI testing
2. **👁️ Visual Testing** — Each chart example can be used to verify visuals and painting are correct
3. **🖼️ Golden Testing** — Provides a basis for golden testing to ensure visual consistency across versions
4. **🖱️ Interactive Testing** — Controls allow for manual testing of different chart configurations and edge cases
