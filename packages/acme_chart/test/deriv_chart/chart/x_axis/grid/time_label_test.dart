import 'package:acme_chart/src/core/chart/x_axis/functions/calc_no_overlay_time_gaps.dart';
import 'package:acme_chart/src/core/chart/x_axis/grid/time_label.dart';
import 'package:flutter_test/flutter_test.dart';
import 'package:acme_chart/src/models/time_range.dart';

void main() {
  test('start of day -> date in format `2 Jul`', () {
    expect(timeLabel(DateTime.parse('2020-07-02 00:00:00Z')), '2 Jul');
  });
  test('start of the month -> full month name', () {
    expect(timeLabel(DateTime.parse('2020-07-01 00:00:00Z')), 'July');
  });
  test('start of the year -> year', () {
    expect(timeLabel(DateTime.parse('2020-01-01 00:00:00Z')), '2020');
  });
