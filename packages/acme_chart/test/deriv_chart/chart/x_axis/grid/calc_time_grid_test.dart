import 'package:acme_chart/src/core/chart/x_axis/grid/calc_time_grid.dart';
  ...
  test('timestamps for 1h interval', () {
    expect(
      gridTimestamps(
        ...
        leftBoundEpoch: DateTime.parse(
          '2020-07-24 22:00:00Z',
        ).millisecondsSinceEpoch,
        rightBoundEpoch: DateTime.parse(
          '2020-07-25 01:00:00Z',
        ).millisecondsSinceEpoch,
      ),
      equals([
    ...
    expect(
      gridTimestamps(
        timeGridInterval: Duration(hours: 1),
        leftBoundEpoch: DateTime.parse(
          '2020-07-24 22:20:00Z',
        ).millisecondsSinceEpoch,
        rightBoundEpoch: DateTime.parse(
          '2020-07-25 01:10:00Z',
        ).millisecondsSinceEpoch,
      ),
      equals([
        DateTime.parse('2020-07-24 23:00:00Z'),
  ...
  test('timestamps for 8h interval', () {
    expect(
      gridTimestamps(
        ...
        leftBoundEpoch: DateTime.parse(
          '2020-07-24 19:00:00Z',
        ).millisecondsSinceEpoch,
        rightBoundEpoch: DateTime.parse(
          '2020-07-25 19:00:00Z',
        ).millisecondsSinceEpoch,
      ),
      equals([
        DateTime.parse('2020-07-25 00:00:00Z'),
  ...
  test('timestamps for 1 month interval', () {
    expect(
      gridTimestamps(
        ...
        leftBoundEpoch: DateTime.parse(
          '2020-06-24 08:00:00Z',
        ).millisecondsSinceEpoch,
        rightBoundEpoch: DateTime.parse(
          '2020-08-29 12:00:00Z',
        ).millisecondsSinceEpoch,
      ),
      equals([
