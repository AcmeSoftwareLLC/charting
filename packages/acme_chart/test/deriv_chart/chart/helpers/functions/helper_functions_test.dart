...
void main() {
  ...
  group('duration to string', () {
    test(
      'durationToString returns the right H:MM:SS format when hour is not 0',
      () {
  ...
  group('getMinMax index function', () {
    ...
    test(
      'Gets the min/max index of a list with no NaN value in the middle',
      () {
        const List<Tick> ticks = <Tick>[
          Tick(epoch: 0, quote: 12),
          Tick(epoch: 1, quote: 13),
