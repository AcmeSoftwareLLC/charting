...
import 'package:acme_chart/src/core/chart/data_visualization/chart_series/indicators_series/abstract_single_indicator_series.dart';
...
class MockMASeries extends AbstractSingleIndicatorSeries {
  MockMASeries(IndicatorInput input, {int offset = 0})
    : super(
...
void main() {
  group('Abstract Single indicator series getEpochOf', () {
    group(
      '''getEpochOf returns correct result 
