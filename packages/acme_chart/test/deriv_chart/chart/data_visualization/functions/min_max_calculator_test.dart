...
import 'package:acme_chart/src/core/chart/data_visualization/functions/min_max_calculator.dart';
  ...
  group('MinMaxCalculator', () {
    test('calculates min/max on initial entries', () {
      final MinMaxCalculator calculator =
          MinMaxCalculator(minValueOf, maxValueOf)..calculate(<Tick>[
    ...
    test('keeps min/max if new entries are the same', () {
      ...
      final MinMaxCalculator calculator = MinMaxCalculator(
        minValueOf,
        maxValueOf,
      )..calculate(testEntries);
