...
import 'package:acme_chart/src/theme/design_tokens/design_token_formatters.dart';
import 'package:acme_chart/src/theme/design_tokens/design_token_utils.dart';
  ...
  group('Token Parser Tests', () {
    ...
    group('Linear Gradient Tests', () {
      ...
      test('Linear Gradient Formatting - Light Category', () {
        ...
        expect(
          result,
          contains("CoreDesignTokens.coreColorOpacityOverflow100"),
        );
    ...
    group('Motion Token Tests', () {
      ...
      test('Motion Token - Cubic Bezier', () {
        String input = "cubic-bezier(0.42, 0, 1, 1)";
        String result = TokenFormatterFactory.getFormatter(
          'motion',
      ...
      test('Motion Token - Unrecognized Error', () {
        ...
        expect(() {
          TokenFormatterFactory.getFormatter(
            'motion',
          ).format(input, DesignTokenUtils.categoryCore);
