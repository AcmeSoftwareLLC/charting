import 'package:acme_chart/src/core/chart/y_axis/quote_grid.dart';
...
void main() {
  group('gridQuotes should', () {
    test('exclude quote on the top edge of canvas (y == 0)', () {
      ...
      expect(yAxisModel.gridQuotes(), isNot(contains(10)));
    });
    test('exclude quote on the bottom edge of canvas (y == canvasHeight)', () {
      ...
      expect(yAxisModel.gridQuotes(), isNot(contains(8)));
    });
    test(
      ...
      () {
        ...
        expect(yAxisModel.gridQuotes(), equals(const <double>[9]));
    ...
    test('return quotes divisible by [quoteGridInterval]', () {
      ...
      expect(yAxisModel.gridQuotes(), equals(const <double>[10, 8, 6]));
      yAxisModel = YAxisModel(
