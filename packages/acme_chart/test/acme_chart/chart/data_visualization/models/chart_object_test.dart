...
import 'package:acme_chart/src/core/chart/data_visualization/models/barrier_objects.dart';
...
void main() {
  group('BarrierObject', () {
    ...
    test(
      'Horizontal Barrier without epoch isOnEpochRange and isOnValueRange',
      () {
