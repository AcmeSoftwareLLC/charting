...
import 'package:acme_chart/src/widgets/market_selector/animated_highlight.dart';
import 'package:acme_chart/src/widgets/market_selector/asset_item.dart';
...
void main() {
  group(
    'Test different scenarios that might break the [MarketSelector] widget',
    () {
      late Asset r50;
      ...
      testWidgets('Add to favourites by clicking star icon', (
        ...
        final Finder favouriteIconFinder = find.byKey(
          const ValueKey<String>('R_50-fav-icon'),
        );
      ...
      testWidgets(
        'No Favourites section when we remove the only favourite item',
        (WidgetTester tester) async {
          ...
          final Finder favouriteIconFinder = find.byKey(
            const ValueKey<String>('R_25-fav-icon'),
          );
        ...
        (WidgetTester tester) async {
          await tester.pumpWidget(
            MaterialApp(
              ...
              home: const MarketSelector(markets: <Market>[]),
            ),
          );
          ...
          const ValueKey<String> textFieldKey = ValueKey<String>(
      ...
      testWidgets('Filtering assets shows the assets containing filter text', (
        ...
        final Finder searchTextFieldFinder = find.byKey(
          const ValueKey<String>('search-bar-text-field'),
        );
