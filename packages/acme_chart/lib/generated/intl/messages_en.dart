...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(String text) => "No results for \"${text}\"";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "informNoResult": m0,
    "labelBandsCount": MessageLookupByLibrary.simpleMessage("Bands Count"),
    "labelBaseLinePeriod": MessageLookupByLibrary.simpleMessage(
      "Base Line Period",
    ),
    ...
    "labelDoubleSmoothingPeriod": MessageLookupByLibrary.simpleMessage(
    ...
    "labelOverBoughtPrice": MessageLookupByLibrary.simpleMessage(
      "Over Bought Price",
    ),
    "labelOverSoldPrice": MessageLookupByLibrary.simpleMessage(
      "Over Sold Price",
    ),
    ...
    "labelSmoothingPeriod": MessageLookupByLibrary.simpleMessage(
      "Smoothing Period",
    ),
    "labelSpanBPeriod": MessageLookupByLibrary.simpleMessage(
      "Leading Span B Period",
    ),
    "labelStandardDeviation": MessageLookupByLibrary.simpleMessage(
      "Standard Deviation",
    ),
