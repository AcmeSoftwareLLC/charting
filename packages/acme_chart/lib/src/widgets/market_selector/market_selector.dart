...
/// the item.
typedef OnAssetClicked =
    void Function({required Asset asset, required bool favouriteClicked});
...
class _MarketSelectorState extends State<MarketSelector>
                ...
                SingleChildScrollView(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      ..._marketsToDisplay!.map(
                        (Market market) => _buildMarketItem(market),
                      ),
                    ],
                  ),
                ),
  ...
  Widget _buildMarketItem(Market market, {bool isCategorized = true}) =>
      MarketItem(
        ...
        filterText: market.containsText(lowerCaseFilterText)
            ? ''
            : lowerCaseFilterText,
        market: market,
        onAssetClicked:
