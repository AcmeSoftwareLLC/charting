...
class ColorGridDropdown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<List<Color>> colorGrid = [
      [theme.toolbarColorPaletteIconRed, theme.toolbarColorPaletteIconBlue],
      [
      ...
      [theme.toolbarColorPaletteIconGreen, theme.toolbarColorPaletteIconGrape],
      [
              ...
              child: Row(
                ...
                children: [
                  for (int i = 0; i < row.length; i++) ...[
                    _ColorOptionButton(
                      color: row[i],
                      selected: row[i].toARGB32() == selectedColor.toARGB32(),
  ...
  Widget build(BuildContext context) {
    ...
    final Widget colorArea = Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: theme.toolbarColorPaletteIconBorderColor),
        color: color,
      ),
    );
