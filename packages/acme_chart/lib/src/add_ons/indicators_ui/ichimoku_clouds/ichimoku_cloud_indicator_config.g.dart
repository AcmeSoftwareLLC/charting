...
IchimokuCloudIndicatorConfig _$IchimokuCloudIndicatorConfigFromJson(
  ...
  conversionLinePeriod: (json['conversionLinePeriod'] as num?)?.toInt() ?? 9,
  ...
  conversionLineStyle: json['conversionLineStyle'] == null
      ...
      : LineStyle.fromJson(json['conversionLineStyle'] as Map<String, dynamic>),
  ...
  laggingLineStyle: json['laggingLineStyle'] == null
      ...
      : LineStyle.fromJson(json['laggingLineStyle'] as Map<String, dynamic>),
