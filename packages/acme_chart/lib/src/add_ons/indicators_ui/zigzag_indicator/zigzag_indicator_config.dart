...
import 'package:acme_chart/src/core/chart/data_visualization/chart_series/indicators_series/zigzag_series.dart';
...
class ZigZagIndicatorConfig extends IndicatorConfig {
  ...
  Series getSeries(IndicatorInput indicatorInput) =>
      ZigZagSeries(indicatorInput, distance: distance, style: lineStyle);
