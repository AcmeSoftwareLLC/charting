...
ADXIndicatorConfig _$ADXIndicatorConfigFromJson(
  ...
  positiveLineStyle: json['positiveLineStyle'] == null
      ...
      : LineStyle.fromJson(json['positiveLineStyle'] as Map<String, dynamic>),
  negativeLineStyle: json['negativeLineStyle'] == null
      ? const LineStyle(color: Colors.red)
      : LineStyle.fromJson(json['negativeLineStyle'] as Map<String, dynamic>),
