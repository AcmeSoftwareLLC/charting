...
import 'package:acme_chart/src/add_ons/drawing_tools_ui/line/line_drawing_tool_item_mobile.dart';
...
class LineDrawingToolConfigMobile extends DrawingToolConfig {
  ...
  const LineDrawingToolConfigMobile({
    ...
    this.lineStyle = const LineStyle(thickness: 0.9, color: BrandColors.coral),
    this.overlayStyle,
