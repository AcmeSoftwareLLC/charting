...
import 'package:acme_chart/src/add_ons/drawing_tools_ui/line/line_drawing_tool_config_mobile.dart';
...
class LineDrawingToolItemMobile extends DrawingToolItem {
  ...
  const LineDrawingToolItemMobile({
    ...
    super.key,
    LineDrawingToolConfigMobile super.config = const LineDrawingToolConfigMobile(),
  }) : super(
          title: 'Line',
        );
