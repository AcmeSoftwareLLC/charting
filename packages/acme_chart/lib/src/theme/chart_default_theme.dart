...
abstract class ChartDefaultTheme implements ChartTheme {
  ...
  BarStyle get barStyle =>
      const BarStyle(positiveColor: LegacyLightThemeColors.accentGreen);
  ...
  VerticalBarrierStyle get verticalBarrierStyle =>
      const VerticalBarrierStyle(textStyle: TextStyles.overLine);

  TextStyle _getStyle({required TextStyle textStyle, required Color color}) {
    _textStyle.putIfAbsent(textStyle, () => <Color, TextStyle>{});
    _textStyle[textStyle]!.putIfAbsent(
      color,
