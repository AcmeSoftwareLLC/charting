...
import 'package:acme_chart/src/theme/painting_styles/data_series_style.dart';
...
class BarStyle extends DataSeriesStyle with EquatableMixin {
  ...
  /// Parses this instance of [BarStyle] into a Map.
  ...
  BarStyle copyWith({Color? positiveColor, Color? negativeColor}) => BarStyle(
