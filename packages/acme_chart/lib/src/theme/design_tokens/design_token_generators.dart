...
abstract class BaseDesignTokenGenerator implements DesignTokenGenerator {
  ...
  void _processValueToken(
    ...
    if (!tokenValues.containsKey(tokenName)) {
      final String tokenValue = _formatTokenValue(
        typedValue['value'],
        typedValue['type']?.toString() ?? 'default',
        category,
      );
      final String description =
          typedValue.containsKey('description') &&
...
class ThemeDesignTokenGenerator extends BaseDesignTokenGenerator {
  ...
  ThemeDesignTokenGenerator(super.className, super.category);
  ...
  String generate(Map<String, dynamic> tokens, List<String> tokenNames) {
    final StringBuffer output = StringBuffer()
      ..write(DesignTokenUtils.designTokenFileHeaderComment)
      ..write(
        'import \'/src/theme/design_tokens/core_design_tokens.dart\';\n\n',
      )
...
class ComponentDesignTokenGenerator extends BaseDesignTokenGenerator {
  ...
  String generate(Map<String, dynamic> tokens, List<String> tokenNames) {
    final StringBuffer output = StringBuffer()
      ..write(DesignTokenUtils.designTokenFileHeaderComment)
      ..write('import \'/src/theme/design_tokens/core_design_tokens.dart\';\n')
      ..write(
        'import \'/src/theme/design_tokens/light_theme_design_tokens.dart\';\n',
      )
      ..write(
        'import \'/src/theme/design_tokens/dark_theme_design_tokens.dart\';\n\n',
      )
  ...
  void _processComponentValueToken(
    ...
    if (!tokenValues.containsKey(tokenName)) {
      ...
      if (tokenPath.startsWith('core.')) {
        ...
        final String coreTokenName = DesignTokenUtils.convertToDartPropertyName(
          tokenPath,
          '',
        );
