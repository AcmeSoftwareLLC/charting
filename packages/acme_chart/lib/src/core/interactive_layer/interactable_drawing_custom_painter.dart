...
import '../../core/interactive_layer/interactive_layer_states/interactive_state.dart';
...
class InteractableDrawingCustomPainter extends CustomPainter {
  ...
  bool shouldRepaint(InteractableDrawingCustomPainter oldDelegate) {
    ...
    final oldDrawingIsInRange = oldDelegate.drawing.isInViewPort(
      oldDelegate.epochRange,
