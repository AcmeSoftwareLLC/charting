...
void drawFocusedCircle(
  ...
  final glowyPaintStyle = paintStyle.glowyCirclePaintStyle(
    lineStyle.color.withValues(alpha: 0.3),
  );
  canvas
    ..drawCircle(offset, outerCircleRadius, glowyPaintStyle)
    ..drawCircle(offset, innerCircleRadius, normalPaintStyle);
}
...
void drawValueLabel({
  ...
  final TextPainter textPainter = _getTextPainter(
    ...
    textStyle: textStyle.copyWith(
      color: textStyle.color?.withValues(alpha: animationProgress),
    ),
  )..layout();
  ...
  if (addNeonEffect) {
    final Paint neonPaint = Paint()
      ..color = color.withValues(alpha: neonOpacity)
  ...
  final Paint rectPaint = Paint()
    ..color = backgroundColor.withValues(alpha: animationProgress)
...
TextPainter _getTextPainter(
  ...
  final TextPainter textPainter = TextPainter(
    text: TextSpan(text: formattedValue, style: textStyle),
