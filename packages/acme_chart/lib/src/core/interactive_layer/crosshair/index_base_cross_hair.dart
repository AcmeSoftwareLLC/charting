...
class IndexBaseCrossHair extends StatefulWidget {
  ...
  const IndexBaseCrossHair({
    ...
    this.crossHairTransitionAnimationDuration = const Duration(
      milliseconds: 100,
    ),
    this.onTap,
    super.key,
  ...
  @override
  State<IndexBaseCrossHair> createState() => _IndexBaseCrossHairState();
}
...
class _IndexBaseCrossHairState extends State<IndexBaseCrossHair>
          ...
          children: <Widget>[
            AnimatedPositioned(
              ...
              child: CustomPaint(
                ...
                painter: widget.crosshairVariant == CrosshairVariant.smallScreen
                    ? CrosshairDotPainter(
                        dotColor: dotColor,
                        dotBorderColor: dotEffect,
                      )
                    : null,
              ),
            ),
              ...
              AnimatedPositioned(
                ...
                child: CustomPaint(
                  ...
                  painter:
                      ...
                      ? SmallScreenCrosshairLinePainter(theme: theme)
                      : LargeScreenCrosshairLinePainter(theme: theme),
                ),
              ),
            ],
          ],
  ...
  Widget _buildCrossHairDetail() => _crossHairDetailSize != null
      ? Align(
          ...
          child: Container(
            ...
            child: Text(
              widget.ticks[_crossHairIndex!].quote.toStringAsFixed(
                widget.pipSize,
              ),
  ...
  int _getCrossHairIndexFromTouchPosition(double touchX) =>
      findClosestIndex(widget.xToIndex(touchX), widget.ticks);
