...
import '../../../../add_ons/drawing_tools_ui/vertical/vertical_drawing_tool_config.dart';
...
import '../../../../core/interactive_layer/interactable_drawings/drawing_adding_preview.dart';
import '../../../../core/interactive_layer/interactable_drawings/vertical_line/vertical_line_adding_preview_desktop.dart';
...
class VerticalLineInteractableDrawing
  ...
  void paint(
    ...
    if (startPoint != null) {
      ...
      if (startPoint == null && _hoverPosition != null) {
        ...
        final Offset startPosition = Offset(_hoverPosition!.dx, 0);
        final Offset endPosition = Offset(_hoverPosition!.dx, size.height);
        canvas.drawLine(
          startPosition,
          endPosition,
  ...
  void onDragUpdate(
    ...
    startPoint = EdgePoint(epoch: newEpoch, quote: startPoint!.quote);
  }
  ...
  @override
  VerticalDrawingToolConfig getUpdatedConfig() => config.copyWith(
