...
import '../../../../add_ons/drawing_tools_ui/horizontal/horizontal_drawing_tool_config.dart';
...
import '../../../../core/interactive_layer/interactable_drawings/horizontal_line/horizontal_line_adding_preview_desktop.dart';
...
class HorizontalLineInteractableDrawing
  ...
  void paint(
    ...
    if (startPoint != null) {
      ...
      if (startPoint == null && _hoverPosition != null) {
        ...
        final Offset startPosition = Offset(0, _hoverPosition!.dy);
        final Offset endPosition = Offset(size.width, _hoverPosition!.dy);
        canvas.drawLine(
          startPosition,
          endPosition,
  ...
  void onDragUpdate(
    ...
    startPoint = EdgePoint(epoch: startPoint!.epoch, quote: newQuote);
  }
