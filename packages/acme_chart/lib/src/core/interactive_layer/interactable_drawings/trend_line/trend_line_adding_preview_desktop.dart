...
import '../../../../core/interactive_layer/helpers/paint_helpers.dart';
import '../../../../core/interactive_layer/interactable_drawings/trend_line/trend_line_adding_preview.dart';
...
class _DesktopRenderer {
  ...
  void renderStartPoint({
    ...
    if (pulseIntensity > 0) {
      final startOffset = _parent.edgePointToOffset(
        startPoint,
        epochToX,
        quoteToY,
      );
  ...
  void renderPreviewLine({
    ...
    final startPosition = _parent.edgePointToOffset(
      startPoint,
      epochToX,
      quoteToY,
    );
