...
import 'segment_interactable_drawing.dart';

/// Base class for segment adding preview implementations.
///
...
abstract class SegmentAddingPreview
    extends DrawingAddingPreview<SegmentInteractableDrawing> {
  /// Initializes the base segment adding preview.
  SegmentAddingPreview({
    required super.interactiveLayerBehaviour,
    required super.interactableDrawing,
    required super.onAddingStateChange,
  });

  /// Retrieves the line style configured for the segment being created.
  ...
  /// Handles the creation of segment points during the drawing process.
  ///
  /// The first tap sets the start point, the second tap sets the end point
  /// and completes the segment.
  void createPoint(
