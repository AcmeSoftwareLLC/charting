...
import 'ellipse_adding_preview.dart';

/// A class to show a preview and handle adding an
/// [EllipseInteractableDrawing] to the chart. It's for when we're on
/// [InteractiveLayerMobileBehaviour].
///
/// This mobile preview provides immediate focus mode by:
/// - Automatically placing a default ellipse in the center of the chart
...
class EllipseAddingPreviewMobile extends EllipseAddingPreview {
  /// Initializes [EllipseAddingPreviewMobile].
  EllipseAddingPreviewMobile({
    ...
    if (interactableDrawing.startPoint == null) {
      ...
      // Position the ellipse to span the chart area with better spacing
  ...
  @override
  String get id => 'ellipse-adding-preview-mobile';
}
