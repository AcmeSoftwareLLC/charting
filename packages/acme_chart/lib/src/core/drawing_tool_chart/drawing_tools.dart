...
/// Which need to be shared between the AcmeChart and the DrawingToolsDialog
class DrawingTools {
  /// Initializes
  DrawingTools({this.onMouseEnterCallback, this.onMouseExitCallback});
  ...
  void init() {
    ...
    if (unfinishedDrawings.isNotEmpty) {
      drawingToolsRepo!.removeAt(
        getDrawingData().indexOf(unfinishedDrawings.first),
      );
    }
