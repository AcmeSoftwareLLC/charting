import '../add_ons/add_on_config.dart';
import '../add_ons/add_ons_repository.dart';
import '../add_ons/drawing_tools_ui/drawing_tool_config.dart';
import '../add_ons/drawing_tools_ui/drawing_tools_dialog.dart';
import '../add_ons/indicators_ui/indicator_config.dart';
import '../add_ons/indicators_ui/indicators_dialog.dart';
import '../add_ons/extensions.dart';
import '../add_ons/repository.dart';
import '../core/chart/chart.dart';
import '../core/chart/data_visualization/annotations/chart_annotation.dart';
import '../core/chart/data_visualization/chart_series/data_series.dart';
import '../core/chart/data_visualization/markers/marker_series.dart';
import '../core/chart/data_visualization/models/chart_object.dart';
import '../core/drawing_tool_chart/drawing_tools.dart';
import '../core/interactive_layer/interactive_layer_controller.dart';
...
class AcmeChart extends StatefulWidget {
  /// Initializes
  const AcmeChart({
  ...
  @override
  State<AcmeChart> createState() => _AcmeChartState();
}

class _AcmeChartState extends State<AcmeChart> {
  ...
  @override
  void didUpdateWidget(covariant AcmeChart oldWidget) {
  ...
  Future<void> loadSavedIndicatorsAndDrawingTools() async {
    ...
    stateRepos.asMap().forEach((
      int index,
      AddOnsRepository<AddOnConfig> element,
    ) {
      try {
          ...
          Chart(
            ...
            overlayConfigs: <IndicatorConfig>[
              ...context.watch<Repository<IndicatorConfig>>().items.where(
                (IndicatorConfig config) => config.isOverlay,
              ),
            ],
