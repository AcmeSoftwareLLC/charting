...
class ChartDataPainter extends BaseChartDataPainter {
  ...
  /// the chart.
  ChartDataPainter({
    required super.chartConfig,
    required super.theme,
    required this.mainSeries,
    required super.epochToCanvasX,
    required super.quoteToCanvasY,
    required super.rightBoundEpoch,
    required super.leftBoundEpoch,
    required super.topY,
    required super.bottomY,
    required super.chartScaleModel,
    List<Series> secondarySeries = const <Series>[],
    super.animationInfo,
  }) : super(series: secondarySeries);
...
class BaseChartDataPainter extends CustomPainter {
  ...
  bool shouldRepaint(BaseChartDataPainter oldDelegate) {
    bool seriesChanged() {
      ...
      final Map<String?, Series> oldSeries = {
        for (var series in oldDelegate.series) series.id: series,
      };

      return series.any(
        (Series series) => series.shouldRepaint(oldSeries[series.id]),
      );
    }
