...
class DonchianChannelsSeries extends Series {
  ...
  SeriesPainter<Series>? createPainter() {
    final HighestValueIndicator<Tick> upperChannelIndicator =
        HighestValueIndicator<Tick>(_highIndicator, config.highPeriod);

    final LowestValueIndicator<Tick> lowerChannelIndicator =
        LowestValueIndicator<Tick>(_lowIndicator, config.lowPeriod);
  ...
  bool didUpdate(ChartData? oldData) {
    ...
    final bool upperUpdated = upperChannelSeries.didUpdate(
      oldSeries?.upperChannelSeries,
    );
    final bool middleUpdated = middleChannelSeries.didUpdate(
      oldSeries?.middleChannelSeries,
    );
    final bool lowerUpdated = lowerChannelSeries.didUpdate(
      oldSeries?.lowerChannelSeries,
    );
