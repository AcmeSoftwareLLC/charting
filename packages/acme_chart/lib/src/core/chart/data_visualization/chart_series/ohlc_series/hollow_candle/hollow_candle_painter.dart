...
class HollowCandlePainter extends OhlcPainter {
  /// Initializes
  HollowCandlePainter(super.series);
  ...
  void onPaintCandle(
    ...
    if (currentPainting.yOpen == currentPainting.yClose) {
      _drawLine(canvas, candleColor, currentPainting);
    } else if (currentPainting.yOpen < currentPainting.yClose) {
      _drawFilledRect(canvas, candleColor, currentPainting);
    } else {
      _drawHollowRect(canvas, candleColor, currentPainting);
    }
  }
