...
class OscillatorLinePainter extends LinePainter {
  ...
  OscillatorLinePainter(
    super.series, {
    this._topHorizontalLine,
    this._bottomHorizontalLine,
  ...
  void onPaintData(
    ...
    final DataLinePathInfo linePath = createPath(
      epochToX,
      quoteToY,
      animationInfo,
    );
    ...
    if (_bottomHorizontalLine != null) {
      ...
      if (kIsWeb) {
        ...
        bottomIntersection = Path.combine(
          PathOperation.intersect,
          topAreaPath,
          bottomRect,
        );
  ...
  void _paintHorizontalLines(Canvas canvas, QuoteToY quoteToY, Size size) {
    ...
    const HorizontalBarrierStyle textStyle = HorizontalBarrierStyle(
