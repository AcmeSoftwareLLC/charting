...
class LinePainter extends DataPainter<DataSeries<Tick>> {
    ...
    if (style.hasArea) {
      final Paint areaPaint = Paint()
        ...
        ..shader = ui.Gradient.linear(
          ...
          <Color>[style.areaGradientColors.start, style.areaGradientColors.end],
        );
  ...
  void paintLines(Canvas canvas, Path path, Paint linePaint) {
