...
class MACDSeries extends Series {
  ...
  bool didUpdate(ChartData? oldData) {
    ...
    final bool signalMACDUpdated = signalMACDSeries.didUpdate(
      series.signalMACDSeries,
    );

    final bool macdHistogramUpdated = macdHistogramSeries.didUpdate(
      series.macdHistogramSeries,
    );
