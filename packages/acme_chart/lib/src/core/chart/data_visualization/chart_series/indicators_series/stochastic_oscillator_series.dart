...
import '../../../../../core/chart/data_visualization/chart_series/indicators_series/models/stochastic_oscillator_options.dart';
...
class StochasticOscillatorSeries extends Series {
  ...
  bool didUpdate(ChartData? oldData) {
    ...
    final bool fastUpdated = fastPercentStochasticIndicatorSeries.didUpdate(
      series?.fastPercentStochasticIndicatorSeries,
    );
    final bool slowUpdated = slowStochasticIndicatorSeries.didUpdate(
      series?.slowStochasticIndicatorSeries,
    );

    return fastUpdated || slowUpdated;
  }
