...
import '../../../../../core/chart/data_visualization/chart_series/data_painters/bar_painting.dart';
...
class BarPainter extends DataPainter<DataSeries<Tick>> {
  /// Initializes
  BarPainter(super.series, {required this.checkColorCallback});
  ...
  void onPaintData(
    ...
    if (lastTick == lastVisibleTick && series.prevLastEntry != null) {
      ...
      final double animatedYQuote = quoteToY(
        ui.lerpDouble(
