...
import '../../../../../core/chart/data_visualization/helpers/combine_paths.dart';
...
class ChannelFillPainter extends DataPainter<DataSeries<Tick>> {
  ...
  void onPaintData(
    ...
    final DataLinePathInfo firstDataPathInfo = _firstLinePainter.createPath(
      epochToX,
      quoteToY,
      animationInfo,
    );
    final DataLinePathInfo secondDataPathInfo = _secondLinePainter.createPath(
      epochToX,
      quoteToY,
      animationInfo,
    );
    ...
    final Path channelFillPath = Path.from(firstDataPathInfo.path)
      ..lineTo(
        secondDataPathInfo.endPosition.dx,
        secondDataPathInfo.endPosition.dy,
      );
