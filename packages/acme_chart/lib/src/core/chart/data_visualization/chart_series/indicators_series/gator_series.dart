...
import '../../../../../core/chart/data_visualization/chart_series/indicators_series/models/alligator_options.dart';
...
class GatorSeries extends Series {
  ...
  bool didUpdate(ChartData? oldData) {
    ...
    final bool gatorBottomUpdated = gatorBottomSeries.didUpdate(
      series?.gatorBottomSeries,
    );
    final bool gatorTopUpdated = gatorTopSeries.didUpdate(
      series?.gatorTopSeries,
    );

    return gatorTopUpdated || gatorBottomUpdated;
  }
