...
class FractalChaosBandSeries extends Series {
  ...
  bool didUpdate(ChartData? oldData) {
    ...
    final bool fcbHighUpdated = fcbHighSeries.didUpdate(series?.fcbHighSeries);
    final bool fcbLowUpdated = fcbLowSeries.didUpdate(series?.fcbLowSeries);
    return fcbHighUpdated || fcbLowUpdated;
  }
  ...
  @override
  int? getMaxEpoch() => <ChartData>[fcbLowSeries, fcbHighSeries].getMaxEpoch();

  @override
  int? getMinEpoch() => <ChartData>[fcbLowSeries, fcbHighSeries].getMinEpoch();
}
