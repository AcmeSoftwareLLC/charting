...
class IchimokuCloudSeries extends Series {
  ...
  bool didUpdate(ChartData? oldData) {
    ...
    final bool conversionLineUpdated = conversionLineSeries.didUpdate(
      series?.conversionLineSeries,
    );
    final bool baseLineUpdated = baseLineSeries.didUpdate(
      series?.baseLineSeries,
    );
    final bool laggingSpanUpdated = laggingSpanSeries.didUpdate(
      series?.laggingSpanSeries,
    );
