...
class FibfanDrawingCreator extends DrawingCreator<FibfanDrawing> {
  ...
  @override
  DrawingCreatorState<FibfanDrawing, FibfanDrawingCreator> createState() =>
      _FibfanDrawingCreatorState();
}

class _FibfanDrawingCreatorState
    extends DrawingCreatorState<FibfanDrawing, FibfanDrawingCreator> {
