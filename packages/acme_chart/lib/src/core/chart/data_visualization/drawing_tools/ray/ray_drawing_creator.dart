...
class RayDrawingCreator extends DrawingCreator<RayLineDrawing> {
  ...
  @override
  DrawingCreatorState<RayLineDrawing, RayDrawingCreator> createState() =>
      _RayDrawingCreatorState();
}

class _RayDrawingCreatorState
    extends DrawingCreatorState<RayLineDrawing, RayDrawingCreator> {
