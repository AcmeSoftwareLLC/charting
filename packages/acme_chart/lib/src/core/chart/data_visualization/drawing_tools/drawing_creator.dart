...
abstract class DrawingCreator<T extends Drawing> extends StatefulWidget {
  ...
  @override
  DrawingCreatorState<Drawing, DrawingCreator<Drawing>> createState();
}
...
abstract class DrawingCreatorState<
  T extends Drawing,
  W extends DrawingCreator<T>
>
    extends State<W> {
  ...
  void onTap(TapUpDetails details) {
    // TODO(sarbagya-acme): We need to apply some refactors here once all the
