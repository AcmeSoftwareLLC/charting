...
class ChannelDrawingCreator extends DrawingCreator<ChannelDrawing> {
  ...
  @override
  DrawingCreatorState<ChannelDrawing, ChannelDrawingCreator> createState() =>
      _ChannelDrawingCreatorState();
}

class _ChannelDrawingCreatorState
    extends DrawingCreatorState<ChannelDrawing, ChannelDrawingCreator> {
  @override
