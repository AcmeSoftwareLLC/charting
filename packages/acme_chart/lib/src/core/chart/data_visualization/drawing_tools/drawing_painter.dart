...
class DrawingPainter extends StatefulWidget {
  ...
  @override
  State<DrawingPainter> createState() => _DrawingPainterState();
        ...
        if (index > -1) {
          ...
          final DrawingToolConfig updatedConfig = config.copyWith(
            edgePoints: <EdgePoint>[
              ...
              // TODO(sarbagya-acme): Change the way storing edge points
    ...
    void onPanUpdate(DragUpdateDetails details) {
      if (widget.drawingData!.isSelected &&
        ...
        setState(() {
          ...
          _draggableStartPoint =
              _draggableStartPoint.copyWith(isDrawingDragged: _isDrawingDragged)
                ..updatePositionWithLocalPositions(
                  ...
                  isOtherEndDragged:
                      _draggableEndPoint.isDragged ||
                      _draggableMiddlePoint.isDragged,
                );
          _draggableMiddlePoint =
              _draggableMiddlePoint.copyWith(
          ...
          _draggableEndPoint =
              _draggableEndPoint.copyWith(isDrawingDragged: _isDrawingDragged)
                ..updatePositionWithLocalPositions(
                  details.delta,
                  xAxis,
                  widget.quoteFromCanvasY,
            ...
            child: RepaintBoundary(
              child: GestureDetector(
                ...
                onLongPressMoveUpdate: (LongPressMoveUpdateDetails details) {
                  final DragUpdateDetails dragDetails = convertLongPressToDrag(
                    details,
                    _previousPosition,
                  );
                  _previousPosition = details.localPosition;
