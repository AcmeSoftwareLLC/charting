...
import '../../../../../core/chart/data_visualization/functions/min_max_calculator.dart';
...
class TrendDrawing extends Drawing {
  ...
  MinMaxCalculator? _setCalculator(
    ...
    final List<Tick> epochRange = series!.sublist(
      minimumEpochIndex,
      maximumEpochIndex,
    );
  ...
  // TODO(sarbagya-acme): implement onDrawingMoved here later
  ...
  void onPaint(
    ...
    final int maximumEpoch =
        draggableEndPoint != null && draggableEndPoint.getEdgePoint().epoch != 0
    ...
    if (endXCoord < startXCoord && endEdgePoint.epoch != 0) {
      final double tempCoord = endXCoord;
      endXCoord = startXCoord;
      startXCoord = tempCoord;
          ...
          ..drawRect(
            ...
            drawingData.shouldHighlight
                ? paint.glowyLinePaintStyle(
                    fillStyle.color.withValues(alpha: 0.2),
                    lineStyle.thickness,
                  )
