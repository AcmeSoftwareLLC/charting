import '../../../../../../core/chart/data_visualization/annotations/barriers/accumulators_barriers/accumulators_closed_indicator.dart';
...
class AccumulatorsClosedIndicatorPainter
  ...
  void onPaint({
    ...
    paintWithTextPainter(
      canvas,
      painter: highBarrierLabelPainter,
      anchor: highBarrierLabelAnchor,
    );

    paintWithTextPainter(
      canvas,
      painter: lowBarrierLabelPainter,
      anchor: lowBarrierLabelAnchor,
    );
