...
import '../../../../../../core/chart/data_visualization/annotations/barriers/accumulators_barriers/accumulators_indicator.dart';
import '../../../../../../core/chart/data_visualization/annotations/barriers/horizontal_barrier/horizontal_barrier.dart';
...
import '../../../../../../core/chart/data_visualization/models/accumulator_object.dart';
import '../../../../../../core/chart/data_visualization/models/animation_info.dart';
import '../../../../../../core/chart/helpers/paint_functions/create_shape_path.dart';
...
class AccumulatorIndicatorPainter extends SeriesPainter<AccumulatorIndicator> {
  ...
  void onPaint({
    ...
    final Offset lowBarrierPosition = Offset(barrierX, quoteToY(lBarrierQuote));

    final Offset tickPosition = Offset(tickX, quoteToY(tickQuote));
    ...
    if (series.labelVisibility ==
      ...
      if (labelCenterPosition.dy - labelHalfHeight < 0) {
        ...
        labelCenterPosition = Offset(
          labelCenterPosition.dx,
          size.height - labelHalfHeight,
        );
    ...
    if (animatedProfit != null && animatedProfit != 0) {
      final TextPainter profitPainter = makeTextPainter(
        '${animatedProfit < 0 ? '' : '+'}${animatedProfit.toStringAsFixed(indicator.activeContract!.fractionalDigits)}',
      ...
      final Offset profitPosition = Offset(
        textStartX + profitPainter.width / 2,
        tickPosition.dy,
      );

      final Offset currencyPosition = Offset(
        textStartX + profitPainter.width + currencyPainter.width / 2 + padding,
        tickPosition.dy,
      );
    ...
    final Path upperTrianglePath = Path()
      ..moveTo(highBarrierPosition.dx, highBarrierPosition.dy)
      ..lineTo(highBarrierPosition.dx + triangleEdge, highBarrierPosition.dy)
      ..lineTo(highBarrierPosition.dx, highBarrierPosition.dy + triangleHeight)
      ..lineTo(highBarrierPosition.dx + -triangleEdge, highBarrierPosition.dy)
      ..close();

    final Path lowerTrianglePath = Path()
      ..moveTo(lowBarrierPosition.dx, lowBarrierPosition.dy)
      ..lineTo(lowBarrierPosition.dx + triangleEdge, lowBarrierPosition.dy)
      ..lineTo(lowBarrierPosition.dx, lowBarrierPosition.dy - triangleHeight)
      ..lineTo(lowBarrierPosition.dx + -triangleEdge, lowBarrierPosition.dy)
      ..close();
  ...
  void _paintUpwardArrows(
    ...
    canvas
      ...
      ..drawPath(
        getUpwardArrowPath(center.dx, center.dy, size: arrowSize),
  ...
  void _paintDownwardArrows(
    ...
    canvas
      ...
      ..drawPath(
        getDownwardArrowPath(center.dx, center.dy, size: arrowSize),
        arrowPaint..color = _paint.color.withValues(alpha: 0.64),
      )
      ..drawPath(
        getDownwardArrowPath(
  ...
  void _paintLine(
    ...
    if (style.isDashed) {
      ...
      canvas.drawLine(
        Offset(mainLineStartX, y),
        Offset(mainLineEndX, y),
        _paint,
      );
    }
  }
