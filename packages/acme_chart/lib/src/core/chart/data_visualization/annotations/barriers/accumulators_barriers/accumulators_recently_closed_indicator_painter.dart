import '../../../../../../core/chart/data_visualization/annotations/barriers/accumulators_barriers/accumulators_recently_closed_indicator.dart';
...
class AccumulatorsRecentlyClosedIndicatorPainter
  ...
  void onPaint({
    ...
    final Path dialogTrianglePath = Path()
      ..moveTo(exitTickPosition.dx - dotPadding, exitTickPosition.dy)
      ..lineTo(
      ...
      ..lineTo(exitTickPosition.dx - dotPadding, exitTickPosition.dy)
      ..close();
