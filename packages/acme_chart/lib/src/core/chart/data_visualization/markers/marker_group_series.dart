...
import '../../../../core/chart/data_visualization/markers/marker_group_painter.dart';
...
import '../../../../core/chart/data_visualization/markers/active_marker_group.dart';
...
class MarkerGroupSeries extends MarkerSeries {
  ...
  SeriesPainter<MarkerGroupSeries> createPainter() {
    return MarkerGroupPainter(this, markerGroupIconPainter);
  }
  ...
  void onUpdate(int leftEpoch, int rightEpoch) {
    if (markerGroupList != null) {
      visibleMarkerGroupList = markerGroupList!.where((MarkerGroup group) {
