...
import '../../../../../core/chart/data_visualization/markers/marker_icon_painters/tick_marker_icon_painter.dart';
...
class AccumulatorMarkerIconPainter extends TickMarkerIconPainter {
  ...
  Offset _getOffset(ChartMarker marker, EpochToX epochToX, QuoteToY quoteToY) =>
  ...
  void _drawShadedBarriers({
    ...
    final Color shadeColor = barrierColor.withValues(alpha: 0.08);
      ...
      if (isTopVisible || hasPersistentBorders) {
        ...
        if (highMarker.text != null) {
          ...
          paintWithTextPainter(
            ...
            painter: textPainter,
            anchor: Offset(
              endLeft - YAxisConfig.instance.cachedLabelWidth! - 1,
              displayedTop - 10,
            ),
