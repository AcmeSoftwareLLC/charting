...
extension ChartDataListExtension on Iterable<ChartData?> {
  ...
  int? _getEpochWithPredicate(
    ...
    final Iterable<int?> maxEpochs = where(
      (ChartData? c) => c != null,
  ...
  double getMinValue() {
    final Iterable<double> minValues = where(
      (ChartData? c) => c != null && !c.minValue.isNaN,
  ...
  double getMaxValue() {
    final Iterable<double> maxValues = where(
      (ChartData? c) => c != null && !c.maxValue.isNaN,
