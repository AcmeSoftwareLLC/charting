...
import '../../../../core/chart/helpers/functions/convert_range.dart';
...
class ChartScaleModel {
  ...
  const ChartScaleModel({required this.granularity, required this.msPerPx});
  ...
  ChartScaleModel copyWith({double? msPerPx, int? granularity}) {
