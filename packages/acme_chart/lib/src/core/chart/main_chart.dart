...
import '../../core/interactive_layer/crosshair/crosshair_controller.dart';
...
import '../../core/chart/custom_painters/chart_data_painter.dart';
import '../../core/chart/custom_painters/chart_painter.dart';
import '../../core/chart/data_visualization/markers/marker_area.dart';
...
class MainChart extends BasicChart {
  ...
  MainChart({
    required DataSeries<Tick> super.mainSeries,
    ...
    super.opacity,
    super.chartAxisConfig,
    super.onQuoteAreaChanged,
  ...
  @override
  BasicChartState<MainChart> createState() => _ChartImplementationState();
}
...
class _ChartImplementationState extends BasicChartState<MainChart> {
  ...
  void _setupController() {
    ...
    widget.controller?.getYFromQuote = (double quote) =>
        chartQuoteToCanvasY(quote);
        ...
        child: Stack(
          ...
          children: <Widget>[
            ...
            if (widget.showDataFitButton &&
                (widget._mainSeries.entries?.isNotEmpty ?? false))
              Positioned(bottom: 0, left: 0, child: _buildDataFitButton()),
          ],
        ),
      );
    },
