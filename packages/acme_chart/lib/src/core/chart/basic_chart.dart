...
import '../../core/chart/y_axis/y_grid_label_painter_web.dart';
import '../../core/chart/y_axis/y_grid_line_painter.dart';
...
class BasicChartState<T extends BasicChart> extends State<T>
  ...
  bool _quoteBoundUpdateScheduled = false;
  ...
  List<double> calculateGridLineQuotes(YAxisModel yAxisModel) {
    ...
    if (newGridLineQuotes.isNotEmpty &&
      ...
      widget.onQuoteAreaChanged?.call(
        newGridLineQuotes.first,
        newGridLineQuotes.last,
      );
    }
