...
class _ChartStateMobile extends _ChartState {
  ...
  Widget buildChartsLayout(
    ...
    List<Widget> getBottomIndicatorsList(
      BuildContext context,
    ) => widget.indicatorsRepo!.items.mapIndexed((
      int index,
      ...
      final int indexInBottomConfigs = referenceIndexOf(
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        final List<Widget> bottomIndicatorsList = getBottomIndicatorsList(
          context,
        );
        return Column(
          children: <Widget>[
