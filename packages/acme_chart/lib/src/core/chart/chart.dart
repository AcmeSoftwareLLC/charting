...
import '../../core/chart/mobile_chart_frame_dividers.dart';
...
import '../../core/chart/x_axis/x_axis_wrapper.dart';
...
abstract class _ChartState extends State<Chart> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    final ChartScaleModel chartScaleModel = ChartScaleModel(
      granularity: widget.granularity,
    ...
    _controller
      ..getSeriesList = (() => <Series>[...?overlaySeries, ...?bottomSeries])
    ...
    return MultiProvider(
      providers: <SingleChildWidget>[
        ...
        Provider<ChartScaleModel>.value(value: chartScaleModel),
      ],
      child: Ink(
  ...
  void didUpdateWidget(covariant Chart oldWidget) {
    ...
    if (expandedIndex != null &&
      ...
      final int newIndex = widget.bottomConfigs.indexOf(
        oldWidget.bottomConfigs[expandedIndex!],
      );
