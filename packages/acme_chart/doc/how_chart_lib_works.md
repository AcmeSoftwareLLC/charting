...
**AcmeChart** A wrapper around the **chart** widget which provides the UI to add/remove addons (indicators and drawing tools) and to manage saving/restoring selected ones on storage.

\*if you want to have indicators and drawing tools in the chart, you should use **\*AcmeChart** instead of **Chart\*\***
