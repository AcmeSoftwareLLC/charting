...
/// Keltner channel lower band (middle band - [multiplier] * ATR).
///
...
/// [UnimplementedError].
class KeltnerChannelLowerIndicator<T extends IndicatorResult>
  ...
  T calculate(int index) => throw UnimplementedError(
    'KeltnerChannelLowerIndicator has no per-bar Dart implementation. '
  ...
  @override
  void copyValuesFrom(covariant KeltnerChannelLowerIndicator<T> other) {
