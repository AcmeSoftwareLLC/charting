...
class AwesomeOscillatorIndicator<T extends IndicatorResult>
  ...
  AwesomeOscillatorIndicator._(
      super.input, this._smaIndicatorOne, this._smaIndicatorTwo);
  ...
  T calculate(int index) {
    final IndicatorResult smaValueOne = _smaIndicatorOne.getValue(index);
    final IndicatorResult smaValueTwo = _smaIndicatorTwo.getValue(index);

    ///AO = SMA(MEDIAN PRICE, 5)-SMA(MEDIAN PRICE, 34)
    final double quote = smaValueOne.quote - smaValueTwo.quote;
